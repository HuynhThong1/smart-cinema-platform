...
func TestNormalizeTransaction(t *testing.T) {
	for _, tc := range []struct{ id, source, want, wantSource string }{
		{" 01313035/0002 ", "QR_SCAN", "01313035/0002", "QR_SCAN"},
		{"123456/123", "QR_TICKET", "123456/123", "QR_TICKET"},
		{"1234567890/12345", "MANUAL", "1234567890/12345", "MANUAL"},
		{"01313035/0002", "verified", "01313035/0002", "MANUAL"},
		{"", "QR_SCAN", "", "NONE"},
